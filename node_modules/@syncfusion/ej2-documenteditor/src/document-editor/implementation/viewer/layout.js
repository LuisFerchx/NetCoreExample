...
var Layout = /** @class */ (function () {
    ...
    Layout.prototype.layoutBlock = function (block, index) {
        ...
        if (block instanceof ParagraphWidget) {
            ...
            var nextBlockToLayout = this.checkPreviousParaShapeOverlap(block);
    ...
    Layout.prototype.checkPreviousParaShapeOverlap = function (paragraph) {
        if (!(paragraph.containerWidget instanceof TextFrame) && !this.isRelayoutOverlap &&
            ...
            for (var i = 0; i < paragraph.floatingElements.length; i++) {
                ...
                while (block) {
                    if (block instanceof ParagraphWidget) {
                        var paraRect = new Rect(block.x, block.y, block.width, block.height);
                    ...
                    block = block.previousWidget;
                }
                block = paragraph.previousWidget;
            }
    ...
    Layout.prototype.layoutfootNote = function (footnote) {
        ...
        if (footnote.page.bodyWidgets[0].lastChild instanceof TableWidget && ((footnote.page.bodyWidgets[0].lastChild.y + footnote.page.bodyWidgets[0].lastChild.height) > footnote.y)) {
            this.reLayoutTable(footnote.page.bodyWidgets[0].lastChild);
        }
        return footnote;
    };
    ...
    Layout.prototype.checkInbetweenShapeOverlap = function (line) {
        ...
        if (!(line.paragraph.containerWidget instanceof TextFrame) && line.paragraph.bodyWidget) {
            ...
            line.paragraph.bodyWidget.floatingElements.forEach(function (shape) {
                if (isInsideTable_1 && !shape.line.paragraph.isInsideTable) {
                    return;
                }
                ...
                if (_this.isRelayout && !_this.isRelayoutOverlap && _this.viewer.documentHelper.selection.isExistAfter(shape.line.paragraph, line.paragraph)
    ...
    Layout.prototype.reLayoutOrShiftWidgets = function (blockAdv, viewer) {
        var reLayoutItems = blockAdv.bodyWidget.floatingElements.length > 0;
        var block = blockAdv;
        // if (block instanceof ParagraphWidget) {
    ...
    Layout.prototype.splitWidget = function (paragraphWidget, viewer, previousBodyWidget, index, isPageBreak, footWidget) {
        ...
        var maxElementHeight = this.getMaxElementHeight(firstLine);
