...
var Print = /** @class */ (function () {
     ...
     * @private
     */
    Print.prototype.generateDoumentImages = function (documentHelper, pageNumber) {
        var image;
        if (!isNullOrUndefined(pageNumber) && pageNumber <= documentHelper.pages.length && pageNumber >= 1) {
            ...
            var pageHeight = printPage.boundingRectangle.height;
            var pageWidth = printPage.boundingRectangle.width;
