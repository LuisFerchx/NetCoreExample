 ...
 * @private
 */
export declare type TextWrappingStyle = 'Inline' | 'InFrontOfText' | 'BehindText' | 'Square' | 'TopAndBottom' | 'Tight';
/**
 * Form Filling Mode
 */
