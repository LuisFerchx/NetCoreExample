...
export declare class Gantt extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    /** @hidden */
    durationUnitTexts?: Record<string, unknown>;
    /** @hidden */
    durationUnitEditText?: Record<string, unknown>;
    /** @hidden */
     ...
     * @default []
     */
    dataSource: Record<string, unknown>[] | DataManager | Object;
    /**
     ...
     */
    actionBegin: EmitType<Record<string, unknown> | PageEventArgs | FilterEventArgs | SortEventArgs | ITimeSpanEventArgs | IDependencyEventArgs | ITaskAddedEventArgs | ZoomEventArgs>;
    /**
     ...
     * @public
     */
    updateDataSource(dataSource: Record<string, unknown>[], args: object): void;
    /**
