...
function getRangePalette(theme) {
    const palette = ['#50c917', '#27d5ff', '#fcde0b', '#ffb133', '#ff5985'];
    // switch (theme) {
    //     case 'Material':
...
class PdfExport {
    ...
    export(type, fileName, orientation, allowDownload) {
        ...
        const promise = new Promise((resolve, reject) => {
            ...
            const url = window.URL.createObjectURL(new Blob([(new XMLSerializer()).serializeToString(this.control.svgObject)], { type: 'image/svg+xml' }));
