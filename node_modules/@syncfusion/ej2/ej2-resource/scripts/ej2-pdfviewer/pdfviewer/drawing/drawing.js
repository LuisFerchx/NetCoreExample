    ...
    Drawing.prototype.scaleObject = function (sw, sh, pivot, obj, element, refObject) {
        ...
        if (sw !== 1 || sh !== 1) {
            ...
            if (!isLineShapes(obj)) {
                ...
                left = node.wrapper.offsetX - node.wrapper.actualSize.width;
                top_1 = node.wrapper.offsetY - node.wrapper.actualSize.height;
    ...
    Drawing.prototype.checkBoundaryConstraints = function (tx, ty, pageIndex, nodeBounds, isStamp, isSkip) {
        ...
        if (canvas) {
            ...
            if ((right <= width - 10 && left >= 10
                && bottom <= height - 10 && top_2 >= heightDifference) || isSkip) {
                return true;
            }
        }
        return false;
