...
export function textTrim(maxwidth, titletext, font) {
    var textWidth;
    var textLength;
    var text;
    ...
    for (var t = 1; t < textLength; t++) {
        text = titletext.substring(0, t) + '...';
        textWidth = measureText(text, font).width;
...
export function calculateSize(smithchart) {
    ...
    smithchart.availableSize = new SmithchartSize(stringToNumber(smithchart.size.width, containerWidth) || containerWidth || 600, stringToNumber(smithchart.size.height, containerHeight) || containerHeight || 450);
}
...
export function measureText(text, font) {
    ...
    htmlObject.style.fontSize = font.fontSize;
