import { addClass, removeClass, isNullOrUndefined, detach, extend, setStyleAttribute } from '@syncfusion/ej2-base';
...
var SfSplitter = (function () {
    ...
    SfSplitter.prototype.updateClass = function () {
        if (Browser.info.name === MSIE) {
            ...
            for (var i = 0; i < allBar.length; i++) {
                var separatorSize = isNullOrUndefined(this.separatorSize) ? 1 : this.separatorSize;
                setStyleAttribute(allBar[i], { 'padding-left': separatorSize / ORDER_NO + PX,
                ...
                if (!isNullOrUndefined(separator)) {
                    ...
                    separator.addEventListener(FOCUS, function () {
                        if (document.activeElement.classList.contains(SPLIT_BAR)) {
                            ...
                            addClass([_this.currentSeparator], SPLIT_BAR_ACTIVE);
                        }
                    });
                    separator.addEventListener(BLUR, function () {
                        removeClass([_this.currentSeparator], SPLIT_BAR_ACTIVE);
                    });
                }
                if (!isNullOrUndefined(separator)) {
                    if (this.isResizable()) {
    ...
    SfSplitter.prototype.clickHandler = function (e) {
        if (!e.target.classList.contains(NAVIGATE_ARROW)) {
            ...
            addClass([e.target], SPLIT_BAR_HOVER);
        }
        this.updateIconClass();
        var icon = e.target;
