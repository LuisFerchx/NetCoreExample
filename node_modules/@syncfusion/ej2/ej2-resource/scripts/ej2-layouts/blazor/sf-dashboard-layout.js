import { EventHandler, Browser, detach, removeClass } from '@syncfusion/ej2-base';
import { Draggable, isNullOrUndefined, closest } from '@syncfusion/ej2-base';
...
var SfDashboardLayout = (function () {
    ...
    SfDashboardLayout.prototype.initialize = function (property) {
        ...
        if (isNullOrUndefined(this.panels)) {
            this.panels = [];
        }
    ...
    SfDashboardLayout.prototype.upResizeHandler = function (event) {
        ...
        var resizeElement = closest((this.upTarget), '.e-panel');
    ...
    SfDashboardLayout.prototype.moveResizeHandler = function (event) {
        ...
        var movedElement = closest((this.moveTarget), '.e-panel');
    ...
    SfDashboardLayout.prototype.touchMoveResizeHandler = function (event) {
        this.updateMaxTopLeft(event);
        var targetElement = closest((this.moveTarget), '.e-panel');
    ...
    SfDashboardLayout.prototype.downHandler = function (event) {
        this.resizeCalled = false;
        this.panelsInitialModel = this.cloneModels(this.panels);
        var targetElement = closest((event.currentTarget), '.e-panel');
        this.isChanged = true;
    ...
    SfDashboardLayout.prototype.updatePanelSize = function (id, sizeX, sizeY) {
        if (this.panels.length > 0) {
            for (var i = 0; i < this.panels.length; i++) {
                if (this.panels[i].id === id) {
                    if (!isNullOrUndefined(sizeX)) {
                        this.panels[i].sizeX = sizeX;
                    }
                    if (!isNullOrUndefined(sizeY)) {
