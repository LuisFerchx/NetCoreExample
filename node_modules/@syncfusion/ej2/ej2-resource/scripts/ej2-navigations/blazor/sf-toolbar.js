import { KeyboardEvents, isNullOrUndefined as isNOU } from '@syncfusion/ej2-base';
...
import { closest, detach, classList } from '@syncfusion/ej2-base';
...
var SfToolbar = (function () {
    ...
    SfToolbar.prototype.docKeyDown = function (e) {
        ...
        var popCheck = !isNOU(this.popObj) && isVisible(this.popObj.element) && this.options.overflowMode !== 'Extended';
    ...
    SfToolbar.prototype.destroyScroll = function () {
        if (this.scrollModule) {
            if (this.tbarAlign) {
                addClass([this.scrollModule.element], CLS_TBARPOS);
            }
    ...
    SfToolbar.prototype.destroyMode = function () {
        ...
        if (tempEle) {
            removeClass([tempEle], CLS_MULTIROW);
        }
        if (this.popObj) {
    ...
    SfToolbar.prototype.eleFocus = function (closest, pos) {
    ...
    SfToolbar.prototype.render = function () {
        ...
        var width = formatUnit(this.options.width);
        var height = formatUnit(this.options.height);
        if (this.element) {
    ...
    SfToolbar.prototype.initScroll = function (element, innerItems) {
        if (!this.scrollModule && this.checkOverflow(element, innerItems[0])) {
            ...
            if (this.options.isVertical) {
                this.scrollModule = new VScroll({ scrollStep: this.options.scrollStep, enableRtl: this.options.enableRtl }, innerItems[0]);
            }
            else {
                this.scrollModule = new HScroll({ scrollStep: this.options.scrollStep, enableRtl: this.options.enableRtl }, innerItems[0]);
            }
    ...
    SfToolbar.prototype.createPopup = function () {
        ...
        if (element.querySelector('#' + element.id + '_popup.' + CLS_POPUPCLASS)) {
            ...
            var extendEle = createElement('div', {
                id: element.id + '_popup', className: CLS_POPUPCLASS + ' ' + CLS_EXTENDABLECLASS
            });
            var popupEle = createElement('div', { id: element.id + '_popup', className: CLS_POPUPCLASS });
    ...
    SfToolbar.prototype.resize = function () {
        ...
        if (!checkOverflow) {
            ...
            if (!isNOU(multirowele)) {
                ...
                if (this.tbarAlign) {
                    addClass([multirowele], CLS_TBARPOS);
                }
            }
        }
    ...
    setEnableRTL: function (element, enableRtl) {
        if (!isNOU(element) && !isNOU(element.blazor__instance)) {
            ...
            if (enableRtl) {
                ...
                removeClass([element], CLS_RTL);
            }
            if (!isNOU(element.blazor__instance.scrollModule)) {
                if (enableRtl) {
                    addClass([element.blazor__instance.scrollModule.element], CLS_RTL);
                }
                else {
                    removeClass([element.blazor__instance.scrollModule.element], CLS_RTL);
                }
            }
            if (!isNOU(element.blazor__instance.popObj)) {
                if (enableRtl) {
                    addClass([element.blazor__instance.popObj.element], CLS_RTL);
                }
                else {
                    removeClass([element.blazor__instance.popObj.element], CLS_RTL);
                }
            }
