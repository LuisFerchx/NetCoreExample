import { EventHandler, isNullOrUndefined as isNOU, Browser } from '@syncfusion/ej2-base';
import { addClass, closest, formatUnit, createElement, Touch, removeClass } from '@syncfusion/ej2-base';
var LEFT = 'Left';
var RIGHT = 'Right';
var PUSH = 'Push';
var OVER = 'Over';
...
var SfSidebar = (function () {
    ...
    SfSidebar.prototype.setEnableGestures = function (property) {
        ...
        if (this.enableGestures) {
            ...
            this.sidebarElement = new Touch(this.element, { swipe: this.enableGestureHandler.bind(this) });
        }
