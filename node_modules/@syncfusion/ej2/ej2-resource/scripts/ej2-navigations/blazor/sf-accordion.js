import { closest, KeyboardEvents, EventHandler, rippleEffect, attributes } from '@syncfusion/ej2-base';
import { select, isVisible, selectAll } from '@syncfusion/ej2-base';
import { isNullOrUndefined as isNOU, isRippleEnabled, addClass, removeClass } from '@syncfusion/ej2-base';
import { setStyleAttribute as setStyle, Animation } from '@syncfusion/ej2-base';
...
var SfAccordion = (function () {
    ...
    SfAccordion.prototype.expandingItem = function (expandArgs) {
        ...
        var trgt = select('.' + CLS_CONTENT, trgtItemEle);
    ...
    SfAccordion.prototype.hideItem = function (index, isHidden) {
        ...
        if (isHidden) {
            addClass([ele], CLS_ITEMHIDE);
        }
        else {
            removeClass([ele], CLS_ITEMHIDE);
        }
    };
