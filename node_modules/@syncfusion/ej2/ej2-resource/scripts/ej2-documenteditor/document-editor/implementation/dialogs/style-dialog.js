...
var StyleDialog = (function () {
    ...
    StyleDialog.prototype.initStyleDialog = function (localValue, isRtl) {
        ...
        styleTypeValue.innerHTML = '<option>' + localValue.getConstant('Paragraph') + '</option><option>' + localValue.getConstant('Character') + '</option><option>' + localValue.getConstant('Linked Style') + '</option>';
