...
import { Border, Font, TooltipSettings, ContainerArea, AxisSettings, Padding, MarkerSettings, DataLabelSettings } from './model/base';
import { RangeBandSettings } from './model/base';
...
var Sparkline = (function (_super) {
    ...
    Sparkline.prototype.setMouseXY = function (e) {
        var pageX;
        var pageY;
    ...
    __decorate([
        Complex({ size: '14px', fontWeight: 'Medium', color: '#424242', fontStyle: 'Medium', fontFamily: 'Roboto' }, Font)
    ], Sparkline.prototype, "sparkFont", void 0);
