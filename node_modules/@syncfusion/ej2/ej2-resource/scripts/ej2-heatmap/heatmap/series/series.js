...
var Series = (function () {
    ...
    Series.prototype.isCellValueInRange = function (dataXIndex, dataYIndex) {
        ...
        for (var i = 0; i < this.heatMap.toggleValue.length; i++) {
            ...
            var text = parseInt(this.heatMap.cellSettings.tileType === 'Bubble' && this.heatMap.cellSettings.bubbleType === 'SizeAndColor' ?
                bubbleText.toString() : this.text.toString(), 10);
            if (isNaN(text)) {
                isValueInRange = true;
            }
