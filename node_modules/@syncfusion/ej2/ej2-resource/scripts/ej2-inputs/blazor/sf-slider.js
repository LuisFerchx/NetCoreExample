...
var SfSlider = (function () {
    ...
    SfSlider.prototype.wireFirstHandleEventArgs = function () {
        ...
        EventHandler.add(this.firstHandle, 'mouseup touchend', this.sliderBarUp, this);
    };
    ;
    SfSlider.prototype.wireSecondHandleEventArgs = function () {
        EventHandler.add(this.secondHandle, 'mousedown touchstart', this.handleFocus, this);
        EventHandler.add(this.secondHandle, 'mouseup touchend', this.sliderBarUp, this);
    };
    ;
    ...
    SfSlider.prototype.unWireFirstHandleEventArgs = function () {
        ...
        EventHandler.remove(this.firstHandle, 'mouseup touchend', this.sliderBarUp);
    };
    ;
    SfSlider.prototype.unWireSecondHandleEventArgs = function () {
        EventHandler.remove(this.secondHandle, 'mousedown touchstart', this.handleFocus);
        EventHandler.remove(this.secondHandle, 'mouseup touchend', this.sliderBarUp);
    };
    ;
    ...
    SfSlider.prototype.positionToValue = function (pos) {
        var val;
        var diff = parseFloat(formatUnit(this.options.Max)) - parseFloat(formatUnit(this.options.Min));
        if (this.options.Orientation === HORIZONTAL) {
    ...
    SfSlider.prototype.stepValueCalculation = function (value) {
        ...
        var percentStep = (parseFloat(formatUnit(this.options.Step))) /
    ...
    SfSlider.prototype.setLimitBarPosition = function () {
        ...
        if (this.options.Limits.minStart !== null || this.options.Limits.minEnd !== null) {
            ...
            setStyleAttribute(this.limitBar1, (_a = {},
                _a[attrVal] = this.checkHandlePosition(minvalues) - this.checkHandlePosition(this.options.Limits.minStart) + 'px',
                _a));
        }
        if (this.options.Type === RANGESLIDER) {
            if (this.options.Limits.maxStart !== null || this.options.Limits.maxEnd !== null) {
                ...
                setStyleAttribute(this.limitBar2, (_b = {},
                    _b[attrVal] = this.checkHandlePosition(maxvalues) - this.checkHandlePosition(this.options.Limits.maxStart) + 'px',
                    _b));
            }
        }
    };
    ...
    SfSlider.prototype.setTickValuePosition = function () {
        ...
        var count = Math.abs(parseFloat(formatUnit(this.options.Max)) - parseFloat(formatUnit(this.options.Min))) / smallStep;
    ...
    SfSlider.prototype.updateValue = function (makeServerCall) {
        ...
        if (makeServerCall) {
            setTimeout(function () {
                if (_this.isMaterial && _this.options.Tooltip !== null && !isNullOrUndefined(_this.materialHandle) &&
