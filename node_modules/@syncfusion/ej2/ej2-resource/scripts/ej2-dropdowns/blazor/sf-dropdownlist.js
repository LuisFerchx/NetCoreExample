import { Browser, Animation, select, KeyboardEvents } from '@syncfusion/ej2-base';
import { formatUnit, attributes, EventHandler, isNullOrUndefined, addClass, removeClass } from '@syncfusion/ej2-base';
import { closest, setStyleAttribute, createElement, prepend, remove } from '@syncfusion/ej2-base';
...
var SfDropDownList = (function () {
    ...
    SfDropDownList.prototype.onMouseOver = function (e) {
        var currentLi = closest(e.target, '.' + LIST_ITEM);
        ...
        this.popupObj = new Popup(this.popupContainer, {
            ...
            close: function () {
                ...
                for (var _i = 0, scrollableParentElements_1 = scrollableParentElements; _i < scrollableParentElements_1.length; _i++) {
                    ...
                    EventHandler.remove(element, 'scroll', _this.scrollHandler);
                }
