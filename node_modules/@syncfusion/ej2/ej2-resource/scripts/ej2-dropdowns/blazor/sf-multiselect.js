import { Browser, Animation, select, remove } from '@syncfusion/ej2-base';
import { formatUnit, attributes, EventHandler, isNullOrUndefined, addClass, removeClass } from '@syncfusion/ej2-base';
import { closest, setStyleAttribute, createElement, prepend } from '@syncfusion/ej2-base';
...
var SfMultiSelect = (function () {
    ...
    SfMultiSelect.prototype.renderPopup = function (popupElement, popupHolderEle, openEventArgs, isModifiedPopup, options, dataItem) {
        ...
        var listHeight = formatUnit(this.options.popupHeight);
        ...
        if (this.options.popupHeight !== 'auto') {
            ...
            this.list.style.maxHeight = (parseInt(listHeight, 10) - 2).toString() + 'px';
    ...
    SfMultiSelect.prototype.setWidth = function () {
        var width = formatUnit(this.options.popupWidth);
        if (width.indexOf('%') > -1) {
    ...
    SfMultiSelect.prototype.popupCreation = function (popupElement) {
        ...
        this.popupObj = new Popup(this.popupContainer, {
            ...
            close: function () {
                EventHandler.remove(_this.list, 'scroll', _this.setFloatingHeader);
                removeClass([_this.containerElement], ICON_ANIM);
                ...
                if (Browser.isDevice && _this.isFilterLayout()) {
                    removeClass([document.body, _this.popupObj.element], POPUP_FULL_SCREEN);
                    EventHandler.remove(_this.list, 'scroll', _this.listScroll);
                }
                if (_this.options.enableVirtualization) {
                    EventHandler.remove(_this.list, 'scroll', _this.virtualScroll);
                }
                if (_this.popupObj) {
                    _this.popupObj.destroy();
                }
                if (!isNullOrUndefined(_this.isDisposed) && !_this.isDisposed) {
            ...
            open: function () {
                ...
                if (_this.list.querySelector('li') && _this.list.querySelector('li').classList.contains(GROUP) && !popupElement.classList.contains(GROUP_CHECKBOX)) {
                    EventHandler.add(_this.list, 'scroll', _this.setFloatingHeader, _this);
                }
    ...
    SfMultiSelect.prototype.updateDelimViews = function (viewElement, options) {
        ...
        if (delimValues && delimValues.length > 0) {
            ...
            if (!isNullOrUndefined(delimValues)) {
                for (var index = 0; !isNullOrUndefined(delimValues[index]); index++) {
