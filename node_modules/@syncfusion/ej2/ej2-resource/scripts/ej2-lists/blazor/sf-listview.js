...
import { closest, Animation, Touch } from '@syncfusion/ej2-base';
var effectsConfig = {
    'None': [],
...
var SfListView = (function () {
    ...
    SfListView.prototype.clickHandler = function (e) {
        if (this.curUlElement) {
            ...
            if (classList.contains(BACKICON) || classList.contains(HEADERTEXT)) {
                ...
                var li = closest(target.parentNode, '.' + LISTITEM);
                if (li === null) {
                    li = target;
                }
    ...
    SfListView.prototype.mouseHoverHandler = function (e) {
        var currentLiElemet = closest(e.target.parentNode, '.' + LISTITEM);
        if (currentLiElemet) {
    ...
    SfListView.prototype.onArrowKeyDown = function (e, previouse) {
        var siblingLI;
        var liElement;
        var hasChildElement = !isNullOrUndefined(this.curUlElement.querySelector('.' + HASCHILD)) ? true : false;
