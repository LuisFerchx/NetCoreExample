            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.trigger(DiagramEvent[eventName], args)];
                    case 1:
                        eventArgs = _a.sent();
    ...
    Diagram.prototype.endEdit = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.diagramActions & DiagramAction.TextEdit)) return [3, 11];
                        blazor = 'Blazor';
                        ...
                        if (!((isBlazor() && textArea) || !isBlazor())) return [3, 11];
                        text = textArea.value;
                        ...
                        if (!bpmnAnnotation) return [3, 5];
                        if (!(element.textContent !== text || text !== this.activeLabel.text)) return [3, 5];
                        if (!isBlazor()) return [3, 3];
                        if (!(this.textEdit && window && window[blazor])) return [3, 2];
                        eventObj = { 'EventName': 'textEdit', args: JSON.stringify(args) };
                        return [4, window[blazorInterop].updateBlazorDiagramEvents(eventObj, this)];
                    case 1:
                        args = (_a.sent()) || args;
                        _a.label = 2;
                    case 2: return [3, 4];
                    ...
                    case 5:
                        ...
                        if (!(!deleteNode && (element.textContent !== text || text !== this.activeLabel.text))) return [3, 9];
                        if (!isBlazor()) return [3, 8];
                        if (!(window && window[blazor] && this.textEdit)) return [3, 7];
                        eventObj = { 'EventName': 'textEdit', args: JSON.stringify(args) };
                        return [4, window[blazorInterop].updateBlazorDiagramEvents(eventObj, this)];
                    case 6:
                        args = (_a.sent()) || args;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.currentSymbol) return [3, 4];
                        isPhase = false;
                        ...
                        return [4, this.triggerEvent(DiagramEvent.drop, arg)];
                    case 1:
                        arg = (_a.sent()) || arg;
                        return [3, 3];
                    case 2:
