            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.diagram.triggerEvent(event, args)];
                    case 1:
                        temparg = _a.sent();
                        return [2, temparg];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!isBlazor()) return [3, 1];
                        this.diagram.triggerEvent(DiagramEvent.selectionChange, arg);
                        return [3, 4];
                    case 1:
                        blazorArgs = void 0;
                        if (!(window && window[this.blazor] && this.diagram.selectionChange)) return [3, 3];
                        eventObj = { 'EventName': 'selectionChange', args: JSON.stringify(arg) };
                        return [4, window[this.blazorInterop].updateBlazorDiagramEvents(eventObj, this.diagram)];
                    case 2:
                        blazorArgs = _a.sent();
                        _a.label = 3;
                    case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.diagram.enableServerDataBinding(false);
                        if (!hasSelection(this.diagram)) return [3, 5];
