...
export { SelectTool };
var FixedUserHandleTool = (function (_super) {
    ...
    ConnectTool.prototype.mouseUp = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!isBlazor()) return [3, 3];
                        trigger = DiagramEvent.connectionChange;
                        temparg = void 0;
                        if (!(this.tempArgs && this.oldConnector)) return [3, 3];
                        ...
                        blazor = 'Blazor';
                        if (!(window && window[blazor] && this.commandHandler[diagram].connectionChange)) return [3, 2];
                        eventObj = { 'EventName': 'connectionChange', args: JSON.stringify(this.tempArgs) };
                        return [4, window[blazorInterop].updateBlazorDiagramEvents(eventObj, this.commandHandler[diagram])];
                    case 1:
                        temparg = _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    MoveTool.prototype.mouseUp = function (args, isPreventHistory) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(isBlazor() && this.objectType !== 'Port')) return [3, 3];
                        this.commandHandler.updatePropertiesToBlazor(args, false);
                        if (args.source) {
                        ...
                        blazorInterop = 'sfBlazor';
                        blazor = 'Blazor';
                        if (!(window && window[blazor] && this.commandHandler[diagram].positionChange)) return [3, 2];
                    ...
                    case 3:
                        ...
                        if (!(this.objectType !== 'Port')) return [3, 8];
                        if (args.source instanceof Node || args.source instanceof Connector) {
                            if (args.source instanceof Node) {
                        ...
                        if (!(args.source && this.currentTarget && canAllowDrop(this.currentTarget) &&
                            this.commandHandler.isDroppable(args.source, this.currentTarget))) return [3, 7];
                        ...
                        if (!isBlazor()) return [3, 5];
                        arg = getDropEventArguements(args, arg);
                        return [4, this.commandHandler.triggerEvent(DiagramEvent.drop, arg)];
                    case 4:
                        arg = (_a.sent()) || arg;
                        return [3, 6];
                    case 5:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        blazorArgs = void 0;
                        if (!(window && window[blazor] && this.commandHandler[diagram].rotateChange)) return [3, 2];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!this.canCancel) return [3, 3];
                        blazorArgs = void 0;
                        if (!(window && window[blazor] && this.commandHandler[diagram].sizeChange)) return [3, 2];
...
var ConnectorDrawingTool = (function (_super) {
...
var TextDrawingTool = (function (_super) {
...
var ZoomPanTool = (function (_super) {
...
export { ZoomPanTool };
var ExpandTool = (function (_super) {
...
var PolyLineDrawingTool = (function (_super) {
...
var LabelDragTool = (function (_super) {
...
var LabelResizeTool = (function (_super) {
...
var LabelRotateTool = (function (_super) {
