    ...
    DragAndDrop.prototype.updateEventHeight = function (event, index, colIndex) {
        ...
        if (target || !this.parent.activeViewOptions.group.byDate) {
            var dayIndex = !this.parent.activeViewOptions.group.byDate ?
                ...
                : this.parent.getIndexOfDate(this.verticalEvent.dateRender[this.actionObj.groupIndex], util.resetTime(this.parent.getDateFromElement(isNullOrUndefined(index) ? this.actionObj.target : this.targetTd)));
