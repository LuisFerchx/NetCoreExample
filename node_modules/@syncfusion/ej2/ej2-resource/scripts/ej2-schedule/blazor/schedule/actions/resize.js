...
import { addClass, Browser, EventHandler, closest, remove, extend, formatUnit, setStyleAttribute, isNullOrUndefined } from '@syncfusion/ej2-base';
...
var Resize = (function (_super) {
    ...
    Resize.prototype.wireResizeEvent = function (element) {
        ...
        for (var _i = 0, resizeElement_1 = resizeElement; _i < resizeElement_1.length; _i++) {
            ...
            EventHandler.clearEvents(element_1);
    ...
    Resize.prototype.resizeStart = function (e) {
        ...
        this.parent.dotNetRef.invokeMethodAsync('OnResizeStart', args, dataGuid).then(function (dataObj) {
            ...
            _this.actionObj.event = extend({}, dataObj, null, true);
    ...
    Resize.prototype.yearEventsRendering = function (event) {
        ...
        if (this.parent.activeViewOptions.group.resources.length === 0) {
            monthDiff = this.getMonthDiff(event.startTime, util.addDays(endDate, -1));
        }
    ...
    Resize.prototype.getEventCount = function (eventObj, month) {
        ...
        var monthEnd = util.addDays(new Date(this.parent.options.selectedDate.getFullYear(), month + 1, 0), 1);
        ...
        if (this.parent.activeViewOptions.group.resources.length === 0) {
            count = Math.ceil((eventData.endTime.getTime() -
                eventData.startTime.getTime()) / util.MS_PER_DAY);
        }
