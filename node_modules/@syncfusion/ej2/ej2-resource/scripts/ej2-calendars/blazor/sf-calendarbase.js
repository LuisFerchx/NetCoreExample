import { extend, KeyboardEvents, closest } from '@syncfusion/ej2-base';
var calendarBase = {
    initialize: function (element, dotnetRef, keyConfig, value, multiSelection) {
        ...
        defaultKeyConfig = extend(defaultKeyConfig, keyConfig);
    ...
    keyActionHandle: function (value, multiSelection, dotnetRef, e) {
        e.preventDefault();
        var element = closest(e.target, '.' + 'e-calendar');
