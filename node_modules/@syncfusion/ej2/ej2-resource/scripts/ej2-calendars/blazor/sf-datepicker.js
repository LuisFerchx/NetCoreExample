import { Browser, Animation, closest, EventHandler, isNullOrUndefined, } from '@syncfusion/ej2-base';
import { select, createElement, extend, KeyboardEvents, removeClass, remove, formatUnit } from '@syncfusion/ej2-base';
...
var SfDatePicker = (function () {
    ...
    SfDatePicker.prototype.initialize = function () {
        ...
        this.defaultKeyConfigs = extend(this.defaultKeyConfigs, this.options.keyConfigs);
        ...
        this.popupObj = new Popup(this.popupContainer, {
            ...
            open: function () {
                if (document.activeElement !== _this.element && options.isDatePopup) {
                    _this.defaultKeyConfigs = extend(_this.defaultKeyConfigs, options.keyConfigs);
                    _this.calendarElement.children[1].firstElementChild.focus();
                    new KeyboardEvents(_this.calendarElement.children[1].firstElementChild, {
                        eventName: 'keydown',
                        keyAction: _this.CalendarKeyActionHandle.bind(_this),
                        keyConfigs: _this.defaultKeyConfigs
                    });
                    new KeyboardEvents(_this.containerElement.children[_this.index], {
                        eventName: 'keydown',
                        keyAction: _this.CalendarKeyActionHandle.bind(_this),
                        keyConfigs: _this.defaultKeyConfigs
                    });
    ...
    SfDatePicker.prototype.documentHandler = function (e) {
        if ((!isNullOrUndefined(this.popupObj) && (this.containerElement.contains(e.target) ||
