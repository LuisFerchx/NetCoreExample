...
var ExportHelper = (function () {
    ...
    ExportHelper.prototype.processTaskbar = function () {
        ...
        this.flatData.forEach(function (data) {
            ...
            var reduceLeft = ganttProp.isMilestone ? Math.floor(_this.parent.chartRowsModule.taskBarHeight / 2) + 33 : 33;
            taskbar.rightTaskLabel.left = ganttProp.left + ganttProp.width + reduceLeft;
