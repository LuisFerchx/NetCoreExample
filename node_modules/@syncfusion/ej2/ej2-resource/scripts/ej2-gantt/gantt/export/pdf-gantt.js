...
var PdfGantt = (function (_super) {
    ...
    PdfGantt.prototype.drawGantttChart = function () {
        ...
        this.headerDetails.forEach(function (detail, index) {
            ...
            taskbarPoint.y = taskbarPoint.y + pixelToPoint(_this.parent.timelineModule.isSingleTier ? 45 : 60);
            pageStartX = taskbarPoint.x;
            cumulativeHeight = pixelToPoint(_this.parent.timelineModule.isSingleTier ? 45 : 60);
