...
var PdfGanttTheme = (function () {
    ...
    PdfGanttTheme.prototype.setTheme = function (ganttStyle, theme) {
        ...
        ganttStyle.columnHeader.format.lineAlignment = 1;
        ganttStyle.columnHeader.format.alignment = 0;
        ...
        ganttStyle.cell.format.lineAlignment = 1;
        ganttStyle.cell.format.alignment = 0;
        ganttStyle.footer.fontSize = 9.5;
        ganttStyle.footer.fontStyle = 0;
        ganttStyle.footer.format.alignment = 1;
        ganttStyle.footer.format.lineAlignment = 1;
