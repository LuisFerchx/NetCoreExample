...
var Gantt = (function (_super) {
    ...
    Gantt.prototype.processTimeline = function () {
        ...
        this.timelineModule.calculateZoomingLevelsPerDayWidth();
    };
    ...
    Gantt.prototype.windowResize = function () {
        if (!isNullOrUndefined(this.element)) {
            ...
            this.ganttChartModule.updateWidthAndHeight();
    ...
    Gantt.prototype.getContentHeight = function () {
        var scrollHeight = this.ganttChartModule.scrollElement.offsetHeight - 16;
    ...
    Gantt.prototype.excelExport = function (excelExportProperties, isMultipleExport, workbook, isBlob) {
        return this.excelExportModule ? this.treeGrid.excelExport(excelExportProperties, isMultipleExport, workbook, isBlob) : null;
    };
    Gantt.prototype.csvExport = function (excelExportProperties, isMultipleExport, workbook, isBlob) {
