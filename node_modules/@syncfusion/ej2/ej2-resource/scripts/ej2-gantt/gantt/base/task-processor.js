...
var TaskProcessor = (function (_super) {
    ...
    TaskProcessor.prototype.updateWorkWithDuration = function (ganttData) {
        ...
        if (!isNullOrUndefined(resources)) {
            ...
            for (index = 0; index < resourcesLength; index++) {
                resourceUnit = resources[index][this.parent.resourceFields.unit];
                resourceOneDayWork = resourceUnit > 0 ? (actualOneDayWork * resourceUnit) / 100 : actualOneDayWork;
    ...
    TaskProcessor.prototype.updateDurationWithWork = function (ganttData) {
        ...
        if (!isNullOrUndefined(resources)) {
            ...
            for (index = 0; index < resourcesLength; index++) {
                resourceUnit = resources[index][this.parent.resourceFields.unit];
                totalResourceOneDayWork += (resourceUnit > 0 ? (actualOneDayWork * resourceUnit) / 100 : actualOneDayWork);
            }
    ...
    TaskProcessor.prototype.updateOverlappingValues = function (resourceTask) {
        ...
        for (var count = 1; count < tasks.length; count++) {
            ...
            var cEndDate = new Date(currentTask.ganttProperties.endDate.getTime());
            var range = [];
            var rangeObj = {};
            for (var index = 0; index < count; index++) {
                var tStartDate = tasks[index].ganttProperties.startDate;
                var tEndDate = tasks[index].ganttProperties.endDate;
                var rangeObj_1 = {};
