...
let DropDownBase = class DropDownBase extends Component {
    ...
    scrollStop(e) {
        ...
        const liHeight = parseInt(getComputedStyle(this.liCollections[0], null).getPropertyValue('height'), 10);
        const topIndex = Math.round(target.scrollTop / liHeight);
        const liCollections = this.list.querySelectorAll('li');
    ...
    setFixedHeader() {
        ...
        const liWidth = this.liCollections[0].offsetWidth - borderWidth;
